...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header">
        <div class="layui-logo">
            <span style="color: black;size: A5">后台管理系统</span>
        </div>
        <div class="layuimini-header-content">

            <a>
                <div class="layuimini-tool">
                    <i title="展开" class="fa fa-outdent" data-side-fold="1">
                    </i>
                </div>
            </a>
            <!--电脑端头部菜单-->
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" layuimini-content-href="static/html/user/userinfo.jsp" data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" layuimini-content-href="static/html/user/modifypwd.html" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
